...
public class DeleteExpenseTest : CashFlowClassFixture
{
    ...
    public DeleteExpenseTest(CustomWebApplicationFactory webApplicationFactory) : base(webApplicationFactory)
    {
        ...
        _expenseId = webApplicationFactory.Expense_MemberTeam.GetExpenseById();
    }
    ...
    public async Task Sucess()
    {
        ...
        result = await DoGet(requestUri: $"{METHOD}/{_expenseId}", token: _token); //verifica se realmente apagou, buscando pelo id que já foi removido. 
